...
from .backends import _merge_pin_deltas, _pin_deltas_from_params
from .external_backends import build_external_solver_payload
...
def _jsonable(value):
    ...
    if hasattr(value, "__dict__") and value.__class__.__module__.startswith("ryd_gate"):
        return repr(value)
    return value
...
def _default_project_dir() -> Path:
    return Path(__file__).resolve().parents[3] / "julia" / "itensors"
