...
if TYPE_CHECKING:
    ...
    from ryd_gate.backends.exact.legacy.atomic_system import AtomicSystem
...
def solve_gate(
    ...
    """
    from ryd_gate.backends.exact.legacy._registry import check_protocol_compatibility
