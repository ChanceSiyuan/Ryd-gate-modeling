...
def create_our_system(
    ...
    """
    from ryd_gate.backends.exact.legacy.hamiltonian_builders import (
        _build_tq_ham_const,
        _tq_ham_420_our,
        _tq_ham_1013_our,
    ...
    d_ryd_ratio = atom.getDipoleMatrixElement(6, 1, 1.5, -0.5, ryd_level, 0, 0.5, 0.5, 1) / atom.getDipoleMatrixElement(
    ...
    return AtomicSystem(
        ...
        tq_ham_const=tq_ham_const,
        tq_ham_420=tq_ham_420,
